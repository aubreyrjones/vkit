...
public:
    ...
    void updateFocus(ref<Widget> widget);
    void disposeWindow(ref<Window> window);
    void centerWindow(ref<Window> window);
    void moveWindowToFront(ref<Window> window);
    void drawWidgets();
...
protected:
    ...
    Cursor mCursor;
    std::vector<ref<Widget> > mFocusPath;
    Vector2i mFBSize;
    float mPixelRatio;
    int mMouseState, mModifiers;
    Vector2i mMousePos;
    bool mDragActive;
    ref<Widget> mDragWidget = nullptr;
